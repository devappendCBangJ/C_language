    ...
    public partial class Form1 : Form
    {
        ...
        private void btnLabelingCV_Click(object sender, EventArgs e)
        {
            ...
            txtLabelingResult.Text += "ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ" + "\r\n" + 
                                     ...
                                     "50원 개수= " + Convert.ToString(CoinArr[1]) + "\r\n" +
                                     "100원 개수= " + Convert.ToString(CoinArr[2]) + "\r\n" +
                                     "500원 개수= " + Convert.ToString(CoinArr[3]) + "\r\n" +
                                     "총 액수= " + Convert.ToString(CoinTot) + "\r\n";
        }
