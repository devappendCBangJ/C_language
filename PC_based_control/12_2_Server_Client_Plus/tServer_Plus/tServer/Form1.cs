...
namespace tServer
{
    public partial class Form1 : Form
    {
        ...
        private TServer serverCopy2;    //원위치복사용2 소켓    // ● 추가된 부분
        ...
        private void timConnStatus_Tick(object sender, EventArgs e)
        {
            ...
            if (serverCopy2 == null) { lblConnCopy2.Text = "Comm : " + "NULL"; }    // ● 추가된 부분
            else
            {
        ...
        private void btnClose_Click(object sender, EventArgs e)     // 서버 닫기
        {
            ...
            if (serverCopy2 != null) serverCopy2.ServerClose();  // ● 추가된 부분
        }
        ...
        // picDraw에서 마우스 움직임 시, 원 좌표 송신 : 통신 형태 맞으면 x, y좌표 csv 형태 송신    // ● 추가된 부분
